...
template(v-else)
	...
	td(v-else-if="track.action === 'pluck'")
		...
		q-radio(v-model.number="track.string" label="1", :val="0")
		q-radio(v-model.number="track.string" label="2", :val="1")
		q-radio(v-model.number="track.string" label="3", :val="2")
		q-radio(v-model.number="track.string" label="4", :val="3")
